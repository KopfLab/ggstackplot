...
- check out the **[Features](articles/features.html)** vignette for details on all available functionality
- check out the **[Examples](articles/examples.html)** vignette for scientific data examples
